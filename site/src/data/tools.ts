...
export const tools: Record<string, ToolDef> = {
  dk: {
    ...
    sections: [
      ...
      {
        title: 'dk profile',
        body: 'Manage Datakraften profiles -- predefined sets of tools for different developer types.\n\n$ dk profile list\n\nAvailable profiles:\n- minimal -- just system tools and git\n- default -- balanced setup for most developers\n- custom -- your own config, optionally from a remote YAML URL\n\nSwitch profile:\n\n$ dk profile use default\n$ dk apply\n\nNOTE: Re-run apply with the new profile\n\nCustom profile with remote YAML:\n\nThe custom profile is designed for teams and power users. Instead of a fixed preset, it lets you define your own toolset -- either locally or from a remote YAML URL.\n\nIs used when you need:\n- Standardized developer environments across a team\n- Onboarding a new developer without manual setup\n- Overriding the default tool selection to match your stack\n\nThe remote YAML supports the same fields as the local config:\n- System packages (apt, dnf, yum, pacman, brew)\n- Runtime environments (Node.js via fnm, Python via uv, .NET SDK)\n- Shell configuration (Fish, Starship, Atuin, fzf)\n- Editor activation (VS Code, Zed, Cursor)\n- AI developer tools (Copilot, Codex CLI, OpenCode)\n\nSet the URL during initial setup:\n\n$ dk init\n\nOr switch later:\n\n$ dk profile use custom\n> Remote team YAML URL: https://example.com/team-config.yaml\n> Fetching... ✓\n\nDatakraften fetches the YAML fresh and writes it to your local config. Share the URL on a company wiki, in your onboarding docs, or from a private GitHub repo -- everyone on the team can run `dk init` and get the same setup.',
      },
      {
        title: 'dk update',
        id: 'update',
  ...
  teams: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'A minimal config for a Node.js backend team:\n\n| system_packages:\n|   - build-essential\n|   - curl\n|   - git\n|\n| brew_packages:\n|   - fish\n|   - starship\n|   - gh\n|   - docker\n|\n| runtimes:\n|   node:\n|     enabled: true\n|     version: lts\n|   python:\n|     enabled: false\n|   dotnet:\n|     enabled: false\n|\n| shell:\n|   fish:\n|     enabled: true\n|\n| editors:\n|   vscode:\n|     enabled: true\n|\n| ai_tools:\n|   enabled: true\n\nNOTE: With this config, every developer gets Node.js LTS, fish shell with Starship, GitHub CLI, Docker, VS Code detection, and AI tools — nothing more, nothing less.',
      },
      {
        title: 'Example: Full-stack team config',
        body: 'A comprehensive config for a full-stack team working with Node.js, Python, and .NET:\n\n| system_packages:\n|   - build-essential\n|   - curl\n|   - git\n|   - unzip\n|   - postgresql-client\n|   - redis-tools\n|   - jq\n|\n| brew_packages:\n|   - fish\n|   - starship\n|   - atuin\n|   - fzf\n|   - fd\n|   - broot\n|   - bottom\n|   - gh\n|   - docker\n|   - powershell\n|\n| runtimes:\n|   node:\n|     enabled: true\n|     version: lts\n|   python:\n|     enabled: true\n|   dotnet:\n|     enabled: true\n|\n| shell:\n|   fish:\n|     enabled: true\n|\n| editors:\n|   vscode:\n|     enabled: true\n|   zed:\n|     enabled: true\n|\n| ai_tools:\n|   enabled: true\n\nNOTE: This is the same as the default profile, but with additional system tools (postgresql-client, redis-tools, jq) and PowerShell included for automation tasks.',
      },
    ],
    website: '',
  },
