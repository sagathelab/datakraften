  ...
  return (
    <Layout variant="docs" title="Terms of Use">
      <div className="py-8 text-base text-text-primary leading-relaxed space-y-4">
        ...
        <h2 className="text-xl font-bold text-text-primary mt-8 mb-2">License</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-text-primary mt-8 mb-2">Disclaimer</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-text-primary mt-8 mb-2">Third-Party Tools</h2>
        <p>
        ...
        <h2 className="text-xl font-bold text-text-primary mt-8 mb-2">Limitation of Liability</h2>
        <p>
