...
╚═════╝ ╚═╝  ╚═╝   ╚═╝   ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝        ╚═╝   ╚══════╝╚═╝  ╚═══╝`}
      ...
      <section className="features pb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <FeatureCard
            title="~ Editors & Tools"
            packages="VS Code, Zed, Cursor, Codex CLI, OpenCode, PowerShell"
      ...
      <section className="how-to pb-16">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-3 font-jetbrains">
          <Step num="01" text="Install" desc="Bootstrap your workstation" />
          <Arrow />
          <Step num="02" text="dk init" desc="Generate your config" />
          <Arrow />
          <Step num="03" text="dk apply" desc="Install everything" />
          <Arrow />
          <Step num="04" text="dk doctor" desc="Verify your setup" />
          <Arrow />
          <Step num="05" text="dk update" desc="Stay up to date" />
        </div>
      </section>
    </Layout>
  )
...
function Step({ num, text, desc }: { num: string; text: string; desc: string }) {
  return (
    <div className="flex flex-col items-center gap-1.5 p-4 border border-fuchsia-500/20 rounded-lg min-w-[140px] bg-bg-card hover:border-magenta transition-colors">
