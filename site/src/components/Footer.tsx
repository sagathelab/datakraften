    ...
    <footer className="footer border-t border-fuchsia-500/20 px-6 py-8 mt-16">
      <div className="max-w-4xl mx-auto flex flex-col items-center gap-4 text-sm text-text-dim">
        ...
        <div className="flex gap-4 flex-wrap justify-center">
          <a
            href="https://github.com/sagathelab/datakraften/blob/main/LICENSE"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <Link to="/docs" className="hover:text-magenta transition-colors">
            Documentation
          </Link>
          <a
            href="https://github.com/sagathelab/datakraften/blob/main/CONTRIBUTING.md"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-magenta transition-colors"
          >
          ...
          <a
            href="https://github.com/sagathelab/datakraften/blob/main/SECURITY.md"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-magenta transition-colors"
          >
          ...
          <Link to="/privacy" className="hover:text-magenta transition-colors">
            Privacy
          </Link>
        ...
        <p className="text-sm text-text-dim text-center">
          &copy; 2026 Datakraften &mdash; open source (Apache 2.0)
        </p>
      </div>
    </footer>
  )
